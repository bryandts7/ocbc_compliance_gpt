...
def self_query_ojk(llm_model: BaseLanguageModel, vector_store: VectorStore, search_type: str = "similarity", top_k: int = 6):
    ...
    metadata_field_info = [
        ...
        AttributeInfo(
            name="sector",
            description="""The sector of the regulation. Possible values:
    - Pasar Modal
    - Perbankan
    - IKNB
    - Perbankan, Syariah
    ...
    - Perbankan, Pasar Modal, IKNB, Syariah
    ...
    - Syariah""",
        ...
        AttributeInfo(
            ...
            description="""The type of the regulation. Possible values:
    - Peraturan OJK
    - Surat Edaran OJK
    - PPBI
    - Klasifikasi Bapepam
    ...
    - Undang-Undang, Peraturan OJK
    - Undang-Undang, Peraturan Bapepam""",
            type="string",
        ),
        AttributeInfo(
    ...
    # Define prompt
    schema_prompt = """
    Please provide the schema of the structured query. Only the following attributes are supported:
    - title
    - sector
    - subsector
    - regulation_type
